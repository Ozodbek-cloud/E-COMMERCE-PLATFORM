...
import { Upload, Camera, Paperclip } from 'lucide-react'
...
export default function NewProperty() {
  ...
  const handleSubmit = async () => {
    ...
    formData.append("user_id", "user-uuid-123")
    ...
    try {
      const res = await fetch("http://localhost:5000/accommodation/create", {
        method: "POST",
        body: formData
      })
          ...
          <div className="max-w-6xl mx-auto px-6 space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="text-center mt-8">
                <button onClick={handleSubmit} className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-12 py-4 rounded-2xl hover:from-blue-700 hover:to-blue-800">
