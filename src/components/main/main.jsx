    ...
    return (
        <div>
            <header>
                    ...
                    <div className='container'>
                        <nav className='flex justify-between items-center py-5'>
                            ...
                            <div>
                                ...
                                {active && (
                                    <div className="absolute mt-3 right-60 w-56 bg-white border border-gray-200 rounded-2xl -z-50 shadow-2xl overflow-hidden transition-all duration-300">
                ...
                <section>
                    <div className='container py-3 md:flex flex-col items-center justify-center flex-wrap md:justify-between'>
